...
const Rankings = () => {
  return (
    <section className="w-[488px] h-[542px] flex flex-col gap-5 px-5 py-[16px] bg-mainWhite rounded-[8px] max-[1417px]:flex-1 max-[1400px]:w-fit max-[1000px]:w-full">
      <div className=" w-[452px] flex items-center justify-between max-[1417px]:w-full">
